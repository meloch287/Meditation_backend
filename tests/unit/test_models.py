...
def test_user_model():
    ...
    assert user.has_active_premium() is False
...
def test_user_premium_status():
    ...
    assert user.has_active_premium() is True
...
def test_meditation_model():
    ...
    assert meditation.is_premium is False
    assert meditation.category == "Stress"
...
def test_premium_meditation_model():
    ...
    assert meditation.is_premium is True
